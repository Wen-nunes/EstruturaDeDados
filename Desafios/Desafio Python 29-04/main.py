...
def main():
    ...
    while True:
        print("\nMENU:\n")
        print("1- Listar Atletas (Nome ou pontuacao)")
        ...
        if op == 1:
            print("Deseja por 1- Nome ou 2- Pontuação ")
            ...
            pontuacao = input("Digite a Pontuacao: ")
            cadastrar(hash_atleta, nome, apelido, fone, data_nascimento, pontuacao)
        elif op == 3:
            print("Deseja por 1- Nome ou 2- Apelido ")
            op_interna = int(input())
            if op_interna == 1:
            ...
            print("Deseja remover por 1- Nome ou 2- Apelido ")
            op_interna = int(input())
            if op_interna == 1:
